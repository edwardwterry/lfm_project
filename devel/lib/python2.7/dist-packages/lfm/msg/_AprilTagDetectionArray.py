...
"""autogenerated by genpy from lfm/AprilTagDetectionArray.msg. Do not edit."""
import sys
...
class AprilTagDetectionArray(genpy.Message):
  ...
  _type = "lfm/AprilTagDetectionArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','lfm/AprilTagDetection[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = lfm.msg.AprilTagDetection()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%si'%length
