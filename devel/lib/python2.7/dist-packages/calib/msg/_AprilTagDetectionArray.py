...
"""autogenerated by genpy from calib/AprilTagDetectionArray.msg. Do not edit."""
import sys
...
class AprilTagDetectionArray(genpy.Message):
  ...
  _type = "calib/AprilTagDetectionArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','calib/AprilTagDetection[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = calib.msg.AprilTagDetection()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%si'%length
