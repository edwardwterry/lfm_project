...
(cl:defmethod cl:initialize-instance :after ((m <Block>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Block)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name calib-msg:<Block> is deprecated: use calib-msg:Block instead.")))

(cl:ensure-generic-function 'block_id-val :lambda-list '(m))
(cl:defmethod block_id-val ((m <Block>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader calib-msg:block_id-val is deprecated.  Use calib-msg:block_id instead.")
  (block_id m))

(cl:ensure-generic-function 'block_x-val :lambda-list '(m))
(cl:defmethod block_x-val ((m <Block>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader calib-msg:block_x-val is deprecated.  Use calib-msg:block_x instead.")
  (block_x m))

(cl:ensure-generic-function 'block_y-val :lambda-list '(m))
(cl:defmethod block_y-val ((m <Block>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader calib-msg:block_y-val is deprecated.  Use calib-msg:block_y instead.")
  (block_y m))
