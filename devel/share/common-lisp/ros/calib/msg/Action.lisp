...
(cl:defmethod cl:initialize-instance :after ((m <Action>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Action)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name calib-msg:<Action> is deprecated: use calib-msg:Action instead.")))

(cl:ensure-generic-function 'target_tag-val :lambda-list '(m))
(cl:defmethod target_tag-val ((m <Action>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader calib-msg:target_tag-val is deprecated.  Use calib-msg:target_tag instead.")
  (target_tag m))

(cl:ensure-generic-function 'dist-val :lambda-list '(m))
(cl:defmethod dist-val ((m <Action>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader calib-msg:dist-val is deprecated.  Use calib-msg:dist instead.")
  (dist m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <Action>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader calib-msg:angle-val is deprecated.  Use calib-msg:angle instead.")
  (angle m))
