...
(cl:defmethod cl:initialize-instance :after ((m <AprilTagDetection>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AprilTagDetection)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lfm-msg:<AprilTagDetection> is deprecated: use lfm-msg:AprilTagDetection instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <AprilTagDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lfm-msg:id-val is deprecated.  Use lfm-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'size-val :lambda-list '(m))
(cl:defmethod size-val ((m <AprilTagDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lfm-msg:size-val is deprecated.  Use lfm-msg:size instead.")
  (size m))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <AprilTagDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lfm-msg:pose-val is deprecated.  Use lfm-msg:pose instead.")
  (pose m))
