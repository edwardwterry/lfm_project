...
(cl:defmethod cl:initialize-instance :after ((m <Links>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Links)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lfm-msg:<Links> is deprecated: use lfm-msg:Links instead.")))

(cl:ensure-generic-function 'link_id-val :lambda-list '(m))
(cl:defmethod link_id-val ((m <Links>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lfm-msg:link_id-val is deprecated.  Use lfm-msg:link_id instead.")
  (link_id m))

(cl:ensure-generic-function 'link_active_prob-val :lambda-list '(m))
(cl:defmethod link_active_prob-val ((m <Links>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lfm-msg:link_active_prob-val is deprecated.  Use lfm-msg:link_active_prob instead.")
  (link_active_prob m))
