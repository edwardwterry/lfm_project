#! usr/bin/env python
import rospy
from lfm.msg import Action, AprilTagDetectionArray, AprilTagDetection, position
...
# def run():
    action_sub = rospy.Subscriber('/action_request', Action, actionClbk)
    detections_pub = rospy.Publisher('/position_write_topic', position)
