...
class Controller {
    public:
        ...
        void processTag3dCentersClbk(const calib::AprilTagDetectionArray& msg);
        void processActionClbk(const calib::Action& msg);
...
void Controller::processTag3dCentersClbk(const calib::AprilTagDetectionArray& msg){
...
void Controller::processActionClbk(const calib::Action& msg){
